const JourneyBegins = () => {
  return (
    <section id="journey" className="py-20 bg-[#F6F5F4]">
      <div className="max-w-6xl mx-auto px-6">
        ...
        <div className="grid md:grid-cols-3 gap-8">
          <div className="bg-white rounded-3xl p-10 hover:shadow-xl transition">
            <div className="mb-6">
              <img
                src="/Leaf_Icon_2.svg"
                alt="Leaf icon"
            ...
            <h3 className="font-semibold text-2xl mb-4" style={{
                color: "#0D0503",
                fontFamily: "Marcellus, serif",
                fontSize: "28px",
                fontStyle: "normal",
            ...
            <p className="text-gray-600" style={{
              ...
              fontWeight: 400,
              lineHeight: "21px" /* 140% */
            }}>Structured peer interactions that help you reflect, share, and grow through meaningful conversations.</p>
          </div>
          ...
          <div className="bg-white rounded-3xl p-10 hover:shadow-xl transition">
            ...
            <p className="text-gray-600" style={{
              ...
              fontWeight: 400,
              lineHeight: "21px" /* 140% */
            }}>Small group conversations designed for openness, comfort, and honest human connection.</p>
          </div>
          ...
          <div className="bg-white rounded-3xl p-10 hover:shadow-xl transition">
            ...
            <h3 className="font-semibold text-2xl mb-4" style={{
              ...
              fontWeight: 400,
              lineHeight: "21px" /* 140% */
            }}>A private reflection tool to help you understand where you are and what truly matters.</p>
          </div>
        </div>
      </div>
